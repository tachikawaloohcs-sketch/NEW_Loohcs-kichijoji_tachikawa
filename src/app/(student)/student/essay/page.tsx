...
import { PenTool, ArrowLeft, ArrowRight, Play, CheckCircle2 } from "lucide-react";
...
export default function EssayLocusPage() {
    return (
        <div className="min-h-screen bg-[#0A0A0B] text-slate-200">
            {/* Header */}
            <header className="border-b border-rose-900/30 bg-black/50 backdrop-blur sticky top-0 z-10 px-6 py-4 flex items-center justify-between">
                <div className="flex items-center gap-4">
                    <Button variant="ghost" asChild size="icon" className="hover:bg-rose-950/50 rounded-full h-10 w-10 text-slate-400 hover:text-white transition-all">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <h1 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-rose-400 to-orange-400 tracking-tight">
                            小論文対策 Locus
                        </h1>
                    </div>
                </div>
            ...
            <main className="max-w-5xl mx-auto px-6 py-12 md:py-20 animate-in fade-in duration-700">
                <div className="text-center mb-16 space-y-4">
                    <h2 className="text-4xl md:text-5xl font-black tracking-tight text-white">テーマアーカイブ</h2>
